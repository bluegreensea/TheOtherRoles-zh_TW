    ...
    class MeetingHudPatch {
        ...
        static void swapperOnClick(int i, MeetingHud __instance) {
            ...
            if (selectedCount == 0) {
                ...
                if (selections[i]) {
                    ...
                    selections[i] = true;
                    renderer.color = Color.yellow;
                    meetingExtraButtonLabel.text = Helpers.cs(Color.yellow, "確認交換");
                }
            } else if (selectedCount == 2) {
                if (selections[i]) {
                    renderer.color = Color.red;
                    selections[i] = false;
                    meetingExtraButtonLabel.text = Helpers.cs(Color.red, "確認交換");
                }
            }
        }
        ...
        static void swapperConfirm(MeetingHud __instance) {
            ...
            if (firstPlayer != null && secondPlayer != null) {
                ...
                meetingExtraButtonLabel.text = Helpers.cs(Color.green, "交換中!");
                Swapper.charges--;
                meetingExtraButtonText.text = $"可換票次數: {Swapper.charges}";
            }
        }
        ...
        static void populateButtonsPostfix(MeetingHud __instance) {
            ...
            if (addSwapperButtons || addMayorButton) {
                ...
                meetingExtraButtonText.text = addSwapperButtons ? $"可換票次數: {Swapper.charges}" : "";
                ...
                if (addSwapperButtons) {
                    ...
                    meetingExtraButtonLabel.text = Helpers.cs(Mayor.color, "投雙票: " + (Mayor.voteTwice ? Helpers.cs(Color.green, "開") : Helpers.cs(Color.red, "關")));
                }
