...
namespace TheOtherRoles
{
    class RoleInfo {
        ...
        public static RoleInfo sheriff = new RoleInfo("警長", Sheriff.color, "射擊 <color=#FF1919FF>冒牌貨</color>", "射擊冒牌貨", RoleId.Sheriff);
        ...
        public static RoleInfo detective = new RoleInfo("偵探", Detective.color, "通過檢查腳印來找到<color=#FF1919FF>冒牌貨</color>", "檢查腳印", RoleId.Detective);
        ...
        public static RoleInfo swapper = new RoleInfo("掉包者", Swapper.color, "掉包得票來放逐<color=#FF1919FF>冒牌貨</color>", "掉包得票", RoleId.Swapper);
        public static RoleInfo seer = new RoleInfo("靈媒", Seer.color, "你可以看到玩家的死亡", "你可以看到玩家的死亡", RoleId.Seer);
        public static RoleInfo hacker = new RoleInfo("駭客", Hacker.color, "駭入系統來找到<color=#FF1919FF>冒牌貨</color>", "駭入來找到冒牌貨", RoleId.Hacker);
        public static RoleInfo niceMini = new RoleInfo("好 迷你船員", Mini.color, "在你長大之前沒有人可以傷害你", "沒有人可以傷害你", RoleId.Mini);
        public static RoleInfo evilMini = new RoleInfo("壞 迷你船員", Palette.ImpostorRed, "在你長大之前沒有人可以傷害你", "沒有人可以傷害你", RoleId.Mini);
        public static RoleInfo tracker = new RoleInfo("追踪者", Tracker.color, "追踪<color=#FF1919FF>冒牌貨</color>", "追踪冒牌貨", RoleId.Tracker);
        public static RoleInfo snitch = new RoleInfo("密探", Snitch.color, "完成你的任務來找出<color=#FF1919FF>冒牌貨</color>", "完成你的任務", RoleId.Snitch);
        public static RoleInfo jackal = new RoleInfo("豺狼", Jackal.color, "殺死所有船員與<color=#FF1919FF>冒牌貨</color>來勝利", "殺死所有人", RoleId.Jackal);
        public static RoleInfo sidekick = new RoleInfo("跟班", Sidekick.color, "幫助你的豺狼殺死所有人", "幫助你的豺狼殺死所有人", RoleId.Sidekick);
        public static RoleInfo spy = new RoleInfo("間諜", Spy.color, "讓<color=#FF1919FF>冒牌貨</color>混亂", "讓冒牌貨混亂", RoleId.Spy);
        ...
        public static RoleInfo goodGuesser = new RoleInfo("好 賭徒", Guesser.color, "猜測並放逐", "猜測並放逐", RoleId.Guesser);
        public static RoleInfo badGuesser = new RoleInfo("壞 賭徒", Palette.ImpostorRed, "猜測並放逐", "猜測並放逐", RoleId.Guesser);
        public static RoleInfo impostor = new RoleInfo("冒牌貨", Palette.ImpostorRed, Helpers.cs(Palette.ImpostorRed, "破壞跟殺死所有人"), "破壞跟殺死所有人", RoleId.Impostor);
        public static RoleInfo crewmate = new RoleInfo("船員", Color.white, "找到冒牌貨", "找到冒牌貨", RoleId.Crewmate);
