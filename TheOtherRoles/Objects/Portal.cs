...
namespace TheOtherRoles.Objects {
    ...
    public class Portal {
        ...
        public static void startTeleport(byte playerId, byte exit) {
            ...
            string playerNameDisplay = Portalmaker.logOnlyHasColors ? "一個玩家 (" + (Helpers.isLighterColor(playerControl.Data.DefaultOutfit.ColorId) ? "淺" : "深") + ")" : playerControl.Data.PlayerName;
