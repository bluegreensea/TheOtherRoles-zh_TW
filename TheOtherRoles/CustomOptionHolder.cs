...
namespace TheOtherRoles {
    public class CustomOptionHolder {
        ...
        public static void Load() {
            ...
            // Role Options
            presetSelection = CustomOption.Create(0, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "設定組"), presets, null, true);
...
#if RELEASE_JL
            if (!CrowdedModCompatibility.Loaded) {
#endif
            crewmateRolesCountMin = CustomOption.Create(300, Types.General, cs(new Color(204f / 255f, 204f / 255f, 0, 1f), "最小船員職業數"), 15f, 0f, 15f, 1f, null, true, heading: "最小/最大職業數");
            ...
            yoyoBlinkDuration = CustomOption.Create(471, Types.Impostor, "眨眼持續時間", 20f, 2.5f, 120f, 2.5f, yoyoSpawnRate);
            yoyoMarkCooldown = CustomOption.Create(472, Types.Impostor, "標記位置冷卻", 20f, 2.5f, 120f, 2.5f, yoyoSpawnRate);
            yoyoMarkStaysOverMeeting = CustomOption.Create(473, Types.Impostor, "標記位置在會議後保留", true, yoyoSpawnRate);
            yoyoHasAdminTable = CustomOption.Create(474, Types.Impostor, "有管理表", true, yoyoSpawnRate);
            yoyoAdminTableCooldown = CustomOption.Create(475, Types.Impostor, "管理表冷卻", 20f, 2.5f, 120f, 2.5f, yoyoHasAdminTable);
            yoyoSilhouetteVisibility = CustomOption.Create(476, Types.Impostor, "殘影能見度", new string[] { "0%", "10%", "20%", "30%", "40%", "50%" }, yoyoSpawnRate);
            ...
            jackalCanSabotageLights = CustomOption.Create(431, Types.Neutral, "豺狼可破壞燈光", true, jackalSpawnRate);
            ...
            sidekickCanSabotageLights = CustomOption.Create(432, Types.Neutral, "跟班可破壞燈光", true, jackalCanCreateSidekick);
            ...
            trackerTrackingMethod = CustomOption.Create(206, Types.Crewmate, "追踪者如何追踪目標", new string[] { "僅箭頭", "僅接近偵測器", "箭頭 + 接近偵測" }, trackerSpawnRate);
            ...
            thiefCanStealWithGuess = CustomOption.Create(405, Types.Neutral, "小偷可用猜測來偷職業(如果是賭徒)", false, thiefSpawnRate);
            ...
            // Modifier (1000 - 1999)
            modifiersAreHidden = CustomOption.Create(1009, Types.Modifier, cs(Color.yellow, "VIP、誘餌與血族隱藏"), true, null, true, heading: cs(Color.yellow, "死後標籤隱藏"));
            ...
            hideNSeekTimer = CustomOption.Create(3003, Types.HideNSeekMain, cs(Color.yellow, "倒數計時(分)"), 5f, 1f, 30f, 0.5f);
            ...
            // Other options
            maxNumberOfMeetings = CustomOption.Create(3, Types.General, "會議數量(不包括市長會議)", 10, 0, 15, 1, null, true, heading: "遊戲設定");
            ...
            allowParallelMedBayScans = CustomOption.Create(7, Types.General, "允許醫務室並列掃描", false);
            shieldFirstKill = CustomOption.Create(8, Types.General, "免死金牌", false);
            finishTasksBeforeHauntingOrZoomingOut = CustomOption.Create(9, Types.General, "作祟或縮放視野需先做完任務", true);
            deadImpsBlockSabotage = CustomOption.Create(13, Types.General, "阻止死亡偽裝者的破壞", false, null, false);
            camsNightVision = CustomOption.Create(11, Types.General, "當關燈時攝影機切換到夜視鏡", false, null, true, heading: "夜視攝影機");
